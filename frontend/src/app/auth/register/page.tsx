...
import { validateEmail, validateUsername, checkPasswords } from "@/app/components/validationComponents";
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setPasswordError(checkPasswords(e.target.value, confirmPassword));
                                    }}
                                    required
                                />
