            ...
            <table className="table-auto border-collapse border border-gray-400 w-full mb-4">
              <thead>
                <tr>
                  ...
                  <th className="border border-gray-400 px-4 py-2">Provider</th>
            ...
            <table className="table-auto border-collapse border border-gray-400 w-full mb-4">
              <thead>
                <tr>
                  ...
                  <th className="border border-gray-400 px-4 py-2">Privacy</th>
                        ...
                        onClick={() =>
                          handleUpdateCardSet(
                            ...
                            prompt("Enter new category:", set.category) ||
                              set.category,
                            prompt("Enter new description:", set.description) ||
                              set.description,
                        ...
                        onClick={() =>
                          handleUpdateCard(
                            ...
                            prompt("Enter new question:", card.front) ||
                              card.front,
                            prompt("Enter new answer:", card.back) || card.back,
